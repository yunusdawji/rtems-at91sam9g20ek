/*
 * Atmel AT91SAM9G20_USART Register definitions
 *
...
#ifndef __AT91SAM9G20_USART_H__
#define __AT91SAM9G20_USART_H__
...
#define US_FIDI       0x40            /* Chip ID1 Register - FI DI Ratio Register */
#define US_NER        0x44            /* Chip ID2 Register - Number of Erros Register */
#define US_IF         0x4C            /* IrDA Filter Register  */
#define US_MAN	   0x50	      /* Manchester Encoder Decoder Register */
...
#define	US_MR_VAR_SYNC	(1 << 22)		/* Variable Synchronization of Command/Data Sync Start Frame Delimiter*/
#define	US_MR_MAX_ITER	(7 << 24)		/* Max Iterations */
#define	US_MR_FILTER		(1 << 28)		/* Infrared Receive Line Filter */
#define 	US_MR_MAN		(1 << 29)		/* Manchester Encoder/Decoder Enable */
#define	US_MR_MODSYNC	(1 << 30)		/* Manchester Synchronization Mode */
#define 	US_MR_ONEBIT		(1 << 31)		/* Start Frame Delimiter Selector */
...
#define	US_IER_MANE	     BIT20	/* Manchester Error Interrupt Enable */
#define	US_IER_MANE	     BIT24 	/* Manchester Error Interrupt Enable*/
...
} at91sam9g20_usart_regs_t;

#endif /* __AT91SAM9G20_USART_H__ */
