...
static void at91sam9g20_emac_isr (rtems_irq_hdl_param unused);
static void at91sam9g20_emac_isr_on(const rtems_irq_connect_data *unused);
static void at91sam9g20_emac_isr_off(const rtems_irq_connect_data *unused);
static int at91sam9g20_emac_isr_is_on(const rtems_irq_connect_data *irq);

/* Replace the first value with the clock's interrupt name. */
rtems_irq_connect_data at91sam9g20_emac_isr_data = {
    AT91SAM9G20_INT_EMAC,
    at91sam9g20_emac_isr,
    NULL,
    at91sam9g20_emac_isr_on,
    at91sam9g20_emac_isr_off,
    at91sam9g20_emac_isr_is_on
};


/* use the values defined in linkcmds for our use of SRAM */
extern void * at91sam9g20_emac_rxbuf_hdrs;
extern void * at91sam9g20_emac_txbuf;
extern void * at91sam9g20_emac_rxbufs;
...
} at91sam9g20_emac_softc_t;

static at91sam9g20_emac_softc_t softc;


/* The AT91SAM9G20 ethernet fifos are very undersized. Therefore
 * we use the internal SRAM to hold 4 receive packets and one
 * transmit packet.  Note that the AT91SAM9G20 can only queue
 * one transmit packet at a time.
 */

/* function prototypes */
int rtems_at91sam9g20_emac_attach (struct rtems_bsdnet_ifconfig *config,
                                  void *chip);
void at91sam9g20_emac_init(void *arg);
void at91sam9g20_emac_init_hw(at91sam9g20_emac_softc_t *sc);
void at91sam9g20_emac_start(struct ifnet *ifp);
void at91sam9g20_emac_stop (at91sam9g20_emac_softc_t *sc);
void at91sam9g20_emac_txDaemon (void *arg);
void at91sam9g20_emac_sendpacket (struct ifnet *ifp, struct mbuf *m);
void at91sam9g20_emac_rxDaemon(void *arg);
void at91sam9g20_emac_stats (at91sam9g20_emac_softc_t *sc);
static int at91sam9g20_emac_ioctl (struct ifnet *ifp,
...
int rtems_at91sam9g20_emac_attach (
    ...
    )
{
    ...
    p = (void *)&at91sam9g20_emac_rxbuf_hdrs;
    rxbuf_hdrs = (RXBUF_HDR *)p;

    /* one transmit buffer, 1536 bytes maximum */
    txbuf = (unsigned char *)&at91sam9g20_emac_txbuf;

    /* receive buffers starting address */
    rxbuf = (unsigned char *)&at91sam9g20_emac_rxbufs;
    /*
     * Parse driver name
     */
     ...
     */
    if (unitnumber != 0) {
        printk ("Bad AT91SAM9G20 EMAC unit number.\n");
        return 0;
    }
    ...
    ifp->if_mtu = mtu;
    ifp->if_init = at91sam9g20_emac_init;
    ifp->if_ioctl = at91sam9g20_emac_ioctl;
    ifp->if_start = at91sam9g20_emac_start;
...
void at91sam9g20_emac_init(void *arg)
{
    at91sam9g20_emac_softc_t     *sc = arg;
    struct ifnet *ifp = &sc->arpcom.ac_if;

    /*
     *This is for stuff that only gets done once (at91sam9g20_emac_init()
     * gets called multiple times
     */
    if (sc->txDaemonTid == 0) {
        /* Set up EMAC hardware */
        at91sam9g20_emac_init_hw(sc);

        /*      Start driver tasks */
        sc->rxDaemonTid = rtems_bsdnet_newproc("ENrx",
                                               4096,
                                               at91sam9g20_emac_rxDaemon,
                                               sc);
        sc->txDaemonTid = rtems_bsdnet_newproc("ENtx",
                                               4096,
                                               at91sam9g20_emac_txDaemon,
                                               sc);
    } /* if txDaemonTid */
    ...
    BSP_install_rtems_irq_handler(&at91sam9g20_emac_isr_data);

    /* EMAC doesn't support promiscuous, so ignore requests */
    if (ifp->if_flags & IFF_PROMISC) {
        printk ("Warning - AT91SAM9G20 Ethernet driver"
...
} /* at91sam9g20_emac_init_hw() */

void at91sam9g20_emac_start(struct ifnet *ifp)
{
    at91sam9g20_emac_softc_t *sc = ifp->if_softc;
...
void at91sam9g20_emac_txDaemon (void *arg)
{
    at91sam9g20_emac_softc_t *sc = (at91sam9g20_emac_softc_t *)arg;
    struct ifnet *ifp = &sc->arpcom.ac_if;
    struct mbuf *m;
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            if (!m)
                break;
            at91sam9g20_emac_sendpacket (ifp, m);
        }
        ifp->if_flags &= ~IFF_OACTIVE;
    }
}
...
void at91sam9g20_emac_sendpacket (struct ifnet *ifp, struct mbuf *m)
{
    ...
    delay_cnt = 0;
    /* printk("at91sam9g20_emac_sendpacket %p\n", m); */
...
/*        sleep(0);       make sure we don't hog the cpu */
    ...
    EMAC_REG(EMAC_TSR) = (EMAC_TSR_COL | EMAC_TSR_RLE
...
/* Enables at91sam9g20_emac interrupts. */
static void at91sam9g20_emac_isr_on(const rtems_irq_connect_data *unused)
{
...
/* Disables at91sam9g20_emac interrupts */
static void at91sam9g20_emac_isr_off(const rtems_irq_connect_data *unused)
{
...
/* Tests to see if at91sam9g20_emac interrupts are enabled, and
 * returns non-0 if so.
...
static int
at91sam9g20_emac_ioctl (struct ifnet *ifp, ioctl_command_t command, caddr_t data)
{
    at91sam9g20_emac_softc_t *sc = ifp->if_softc;
    int error = 0;
    ...
    case SIOCSIFFLAGS:
        ...
        {
        case IFF_RUNNING:
            at91sam9g20_emac_stop (sc);
            break;

        case IFF_UP:
            at91sam9g20_emac_init (sc);
            break;
...
static void at91sam9g20_emac_isr (rtems_irq_hdl_param unused)
{
    ...
    if (status32 & EMAC_INT_ABT) {
        ...
        rtems_panic("AT91SAM9G20 Ethernet MAC has received an Abort.\n");
    }
