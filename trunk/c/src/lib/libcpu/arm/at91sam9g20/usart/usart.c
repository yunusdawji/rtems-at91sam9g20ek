/*
 *  Driver for AT91SAM9G20 USART ports
 *
 ...
 *
 *  $Id: usart.c,v 1.4 2010/04/30 14:59:51 sh Exp $
*/
...
at91sam9g20_usart_regs_t *usart_get_base(int minor);
...
at91sam9g20_usart_regs_t *usart_get_base(int minor)
{
  ...
  port = (at91sam9g20_usart_regs_t *) console_entry->ulCtrlPort1;
...
static int usart_first_open(int major, int minor, void *arg)
{
  at91sam9g20_usart_regs_t *usart;
...
static int usart_set_attributes(int minor, const struct termios *t)
{
  ...
  brgr = (at91sam9g20_get_mck() / 16) / baud;
