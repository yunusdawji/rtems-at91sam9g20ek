/*
 *  Console driver for AT91SAM9G20 DBGU port
 *
 *  This driver uses the shared console driver in
 *  ...../libbsp/shared/console.c
 *
 *  Copyright (c) 2011 by LIU Xing Hua
 *  Written by Liu Xing Hua <xhl.physics@gmail.com>
 *
...
static int dbgu_read(int minor)
{
    ...
    dbgu = (at91sam9g20_dbgu_regs_t *)console_entry->ulCtrlPort1;
...
static void dbgu_init(int minor)
{
    ...
    /* Set the baud rate */
    dbgu->brgr = (at91sam9g20_get_mck() / 16) / BSP_get_baud();
